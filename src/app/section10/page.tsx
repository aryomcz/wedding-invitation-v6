...
export default function Section10 () {
   ...
   <section className="bg-[#BEB4A3] w-full pt-10 pb-20">
     ...
     <div className=" rounded-3xl bg-bottom bg-no-repeat bg-cover bg-blend-multiply h-full w-full absolute z-10 bg-[#BEB4A3]" style={{backgroundImage: `url('/img/bg-4.jpg')`}}></div>
        ...
        <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-50 z-50 ">
            <div className="bg-white p-4 rounded-lg mx-4 font-lionel max-h-[80vh] overflow-y-scroll">
              ...
              <div className='flex justify-center relative w-fit h-fit'>
                <img src="/img/bank.png" className='sm:w-4/5 lg:w-1/2 h-auto relative' />
              ...
              <div className='flex justify-center relative w-fit h-fit '>
                <img src="/img/bank2.png" className='sm:w-4/5 lg:w-1/2 h-auto relative' />
                <div className='absolute w-full sm:w-4/5 lg:w-1/2 h-full grid grid-rows-4 grid-cols-1'>
                  ...
                  <div className='row-start-2 ml-5'>
                    <img src="/img/qr.png" className="w-1/4" alt="" />
                  </div>
