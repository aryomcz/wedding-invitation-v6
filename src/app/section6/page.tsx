export default function Section6 () {
    return (
        <section className="relative bg-[#BEB4A3] py-10 overflow-hidden w-full -mt-1 text-black">
              <div className="bg-center bg-no-repeat bg-cover bg-blend-multiply h-full w-full absolute bg-[#BEB4A3]" style={{backgroundImage: `url('/img/bg-3.jpg')`}}></div>
              <div className="w-full relative mt-16 pb-56">
                <div className="z-50 flex justify-center p-3 w-full flex-wrap flex-col mt-12 ">
                    ...
                    <div className="font-redressed text-center max-w-full mt-5">
